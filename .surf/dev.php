...
$username = 'web123';
$baseUrl = 'http://web123.server.com';
// Ready for DDEV image
$scriptBasePath = '/var/www/html';

$projectName = 'project';
$deploymentPath = '/home/www/web123.server.com/surf';
$deploymentHost = 'web123.server.com';
$repositoryUrl = 'git@bitbucket.org:vendor/repo.git';
$repositoryBranch = getenv('DEPLOY_BRANCH') ?: 'develop';
$composerCommandPath = 'composer';
// Set this, if on remote host the correct PHP binary is not available in PATH
$deployment->setOption('phpBinaryPathAndFilename', 'php72');
